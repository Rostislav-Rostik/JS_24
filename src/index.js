...
class Ex1 extends React.Component {
    state = {
        employees: [
            { id: 1, firstName: 'Іван', lastName: 'Петров', daysWorked: 20, dailyRate: 200 },
            { id: 2, firstName: 'Марія', lastName: 'Коваль', daysWorked: 25, dailyRate: 180 },
            { id: 3, firstName: 'Олег', lastName: 'Іванов', daysWorked: 22, dailyRate: 190 },
        ],
    };
            ...
            <div key={index}>
                ...
                {this.state.isSubmitted && (
                    <div style={{ color: isCorrect ? 'green' : 'red' }}>
                        Ваша відповідь {isCorrect ? 'правильна' : 'не правильна, правильна відповідь: ' + question.answer}
                    </div>
                )}
                <hr />
            </div>
...
const questions = [
    ...
    {
        question: 'Який варіант типів даних є у JavaScript?',
        answer: 'string, number, boolean, null, undefined, object, symbol',
    },
    {
        question: 'Який метод використовується для зміни стану компонента в React?',
        answer: 'setState',
    },
];
    ...
    constructor(props) {
        ...
        this.state = {
            questions: [
                ...
                {
                    id: 2,
                    text: "Який варіант типів даних є у JavaScript?",
                    correctAnswer: "string, number, boolean, null, undefined, object, symbol",
                    userAnswer: "",
                },
                {
                    id: 3,
                    text: "Який метод використовується для зміни стану компонента в React?",
